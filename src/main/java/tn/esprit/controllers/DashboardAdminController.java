...
public class DashboardAdminController {
    ...
    public void showUsers() {
        ...
        loadInContent("/tn/esprit/interfaces/GestionUsers.fxml", "Gestion des utilisateurs");
    }

    // ─── Filières → chargé dans le contentArea SANS sidebar propre ───────────
    @FXML
    public void showFilieres() {
        setActiveButton(btnFilieres);
        loadInContent("/tn/esprit/interfaces/FiliereContent.fxml", "Gestion des filières");
    }

    @FXML
    public void showOffres() {
        setActiveButton(btnOffres);
        loadInContent("/tn/esprit/interfaces/GestionOffres.fxml", "Offres de stage");
    }

    @FXML
    public void showProfil() {
        setActiveButton(btnProfil);
        if (currentUser != null) ProfilController.setCurrentUser(currentUser);
        loadInContent("/tn/esprit/interfaces/Profil.fxml", "Mon profil");
    }

    // ─── Quiz Admin → chargé dans le contentArea SANS sidebar propre ─────────
    @FXML
    public void showQuizAdmin() {
        setActiveButton(btnQuizAdmin);
        loadInContent("/tn/esprit/interfaces/QuestionContent.fxml", "Gestion des questions Quiz");
    }
    ...
    public void handleLogout() {
        ...
        try {
            Parent root = FXMLLoader.load(
                    getClass().getResource("/tn/esprit/interfaces/Login.fxml"));
            btnDashboard.getScene().setRoot(root);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    /**
     * Charge un FXML dans le contentArea du Dashboard (sidebar toujours visible).
     * Utilisé pour TOUTES les vues — elles n'ont plus leur propre sidebar.
     */
    private void loadInContent(String fxml, String title) {
        try {
