...
public class DashboardEtudiantController {
    ...
    public void initialize() {
        ...
        if (btnRetourDashboard != null) {
            boolean canReturn = sourceDashboardType != null && !sourceDashboardType.isBlank()
                    && !"etudiant".equals(sourceDashboardType);
    ...
    @FXML public void showAboutContact() {
        setActiveButton(btnAboutContact);
        showAboutContactView();
    }

    @FXML public void showCours() {
        setActiveButton(btnCours);
        navigate("/tn/esprit/interfaces/Cours.fxml");
    }

    @FXML public void showQuiz() {
        setActiveButton(btnQuiz);
        navigate("/tn/esprit/interfaces/Quiz.fxml");
    }
    ...
    @FXML public void returnToSourceDashboard() {
        ...
        try {
            ...
            if ("admin".equals(source)) {
                ...
                DashboardProfController.setCurrentUser(currentUser);
    ...
    private void showHomeView() {
        ...
        if (aboutContactView != null) {
            aboutContactView.setManaged(false);
            aboutContactView.setVisible(false);
        }
    }
    ...
    private void showAboutContactView() {
        ...
        aboutContactView.setManaged(true);
        aboutContactView.setVisible(true);
        if (homeView != null) {
    ...
    private void setActiveButton(Button active) {
        ...
        for (Button b : all) {
            if (b == null) continue;
            if (b == active) {
                b.setStyle("-fx-background-color: #eff6ff; -fx-text-fill: #2563eb; -fx-font-weight: bold; -fx-font-size: 13; -fx-padding: 10 16; -fx-background-radius: 8; -fx-cursor: hand; -fx-alignment: CENTER_LEFT; -fx-border-color: #bfdbfe; -fx-border-radius: 8;");
            } else {
                b.setStyle("-fx-background-color: transparent; -fx-text-fill: #5a6a8a; -fx-font-size: 13; -fx-padding: 10 16; -fx-background-radius: 8; -fx-cursor: hand; -fx-alignment: CENTER_LEFT;");
            }
        }
    }
}
